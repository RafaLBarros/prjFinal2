...
export function SceneManager({ scene, campaignNodes, onUpdateModules, onRenameScene }: Props) {
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-6xl 2xl:max-w-7xl mx-auto px-8 lg:px-16 py-8 relative">
      ...
      {/* BARRA INFERIOR */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-slate-800/95 backdrop-blur border border-slate-600 p-2.5 rounded-2xl shadow-2xl flex gap-3 z-[200] transition-transform hover:scale-105">
